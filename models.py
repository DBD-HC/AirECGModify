...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.y_embedder2 = PatchEmbed(input_size, patch_size, in_channels, hidden_size, bias=True)
        self.y_embedder1 = PatchEmbed(input_size, patch_size, mm_channels, hidden_size, bias=True)
    ...
    def initialize_weights(self):
        ...
        w2 = self.y_embedder1.proj.weight.data
        nn.init.xavier_uniform_(w2.view([w2.shape[0], -1]))
        nn.init.constant_(self.y_embedder1.proj.bias, 0)

        w3 = self.y_embedder2.proj.weight.data
        nn.init.xavier_uniform_(w3.view([w3.shape[0], -1]))
        nn.init.constant_(self.y_embedder2.proj.bias, 0)
    ...
    def forward(self, x, t, y1, y2):
        ...
        y1: (N, C, H, W) tensor of mmwave
        y2: (N, 1024) tensor of ref
        """
